...
/* harmony import */ var _components_modal_video_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/modal-video.js */ "./src/js/components/modal-video.js");
...
/***/ "./src/js/components/modal-video.js":
/*!******************************************!*\
  !*** ./src/js/components/modal-video.js ***!
  \******************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  planSliders.forEach(el => {
    resizableSwiper('(max-width: 900px)', el, {
      spaceBetween: 24,
      slidesPerView: 'auto',
      pagination: {
        el: '.plan__pagination',
...
const validateForms = function (selector, rules) {
  ...
  if (telSelector) {
    const inputMask = new _node_modules_inputmask_dist_inputmask_es6_js__WEBPACK_IMPORTED_MODULE_1__["default"]('(999) 999-99-99');
...
const iti = intl_tel_input__WEBPACK_IMPORTED_MODULE_1__(input, {
  initialCountry: "ru",
...
const handleChange = () => {
  ...
  if (input.value) {
    className = iti.isValidNumber() ? "valid" : "invalid";
  }
...
telInput.forEach(el => {
  intl_tel_input__WEBPACK_IMPORTED_MODULE_1__(el, {
    initialCountry: "ru",
    separateDialCode: true
  });
...
(0,_functions_validate_forms_js__WEBPACK_IMPORTED_MODULE_2__.validateForms)('.quiz__slider', rules1, [], afterForm);
(0,_functions_validate_forms_js__WEBPACK_IMPORTED_MODULE_2__.validateForms)('.modal__form', rules2, [], afterForm);
